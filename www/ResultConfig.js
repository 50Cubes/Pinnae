var RESULTS_CONFIG = {
	good: [
		...
		{
			preSound: ['sound/planttap_pre_L.mp3', 'sound/planttap_pre_F.mp3', 'sound/planttap_pre_R.mp3'],
			soundDelay: 4000,
			postSound: ['sound/planttap_post_good.mp3', 'sound/planttap_post_good.mp3', 'sound/planttap_post_good.mp3'],
			sprite: ['img/Monster_tiger1.jpg','img/Monster_tiger2.jpg'],
			anxietyChange: -10,
			inventoryItem: true	
		}
	...
	bad: [
		...
		},
		{
			preSound: ['sound/planttap_pre_L.mp3', 'sound/planttap_pre_F.mp3', 'sound/planttap_pre_R.mp3'],
			soundDelay: 4000,
			postSound: ['sound/planttap_post_bad.mp3', 'sound/planttap_post_bad.mp3', 'sound/planttap_post_bad.mp3'],
			sprite: ['img/Monster_tiger1.jpg','img/Monster_tiger2.jpg'],
			anxietyChange: 10,
			inventoryItem: true	
		}
